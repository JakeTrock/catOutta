...
export const Finder = (props: FinderProps) => {
    const { scanCount, hideCount, tracker, border = 80, result, video, constraints, useScreenCapture, deviceId, scanDelay } = props;
    ...
    return (
        <Fragment>
            ...
            {tracker && <Tracker video={video} result={result} useScreenCapture={useScreenCapture} constraints={constraints} deviceId={deviceId} scanDelay={scanDelay} />}
            <svg
                viewBox="0 0 100 100"
                style={{
                    top: 0,
